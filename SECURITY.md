...
Replace this section with the supported versions for `agentabi`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `agentabi` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in agentabi.
